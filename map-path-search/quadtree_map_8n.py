...
filename = 'examples/maps/example_map_binary.png'
...
#     # plot path
#     cv.create_line(path[0][0], canvas_height - path[0][1], path[1][0], canvas_height - path[1][1], fill=color,
#                    width=width)
#     for i in range(1, len(path)):
#         cv.create_line(path[i - 1][0], canvas_height - path[i - 1][1], path[i][0], canvas_height - path[i][1],
